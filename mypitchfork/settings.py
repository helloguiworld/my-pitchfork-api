"""
Django settings for mypitchfork project.
...
SECRET_KEY = 'django-insecure-93!1&80ov-k3rhb-r_pvs(*3c0@(acqj2$407gjitk2ucgsn5h'
...
WSGI_APPLICATION = 'mypitchfork.wsgi.application'
